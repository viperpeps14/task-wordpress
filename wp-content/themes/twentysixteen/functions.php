...
add_action( 'wp_ajax_feedbackform', 'feedback_form' );
add_action( 'wp_ajax_nopriv_feedbackform', 'feedback_form' );
// первый хук для авторизованных, второй для не авторизованных пользователей

function feedback_form(){

    require('handler_feedback-form.php');
    die;
}

function fancy_scripts() {
    if (!is_single() ) {
        wp_enqueue_script( 'fancybox-script', get_stylesheet_directory_uri() .'/js/jquery.fancybox.min.js', array(), '3.3.5', true );
    }
}
...
function main_scripts() {
    if (!is_single() ) {
        wp_enqueue_script( 'main-script', get_stylesheet_directory_uri() .'/js/main.js', array(), '1', true );
    }
}
...
function fancy_footer_styles() {
    if ( !is_single() ) {
        wp_enqueue_style( 'fancy_footer_styles',get_stylesheet_directory_uri() .'/css/jquery.fancybox.min.css' );
    }
};
